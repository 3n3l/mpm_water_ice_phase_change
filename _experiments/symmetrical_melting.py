"""This shows the SYMMETRICAL MELTING, that happened before reworking the interpolation."""
...
def main():
    ...
    print(utils.print_yellow("SYMMETRICAL MELTING"))
